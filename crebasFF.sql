...
/* Date de création :  25/11/2021 14:12:27                      */
/*==============================================================*/
...
if exists(
   ...
   drop index PlanificationEntretien.ASSOCIATION13_FK
end if;

if exists(
   select 1 from sys.sysindex i, sys.systable t
   where i.table_id=t.table_id 
     and i.index_name='ASSOCIATION14_FK'
     and t.table_name='PlanificationEntretien'
) then
   drop index PlanificationEntretien.ASSOCIATION14_FK
end if;
