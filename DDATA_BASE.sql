...
/* Date de création :  06/09/2021 14:47:18                      */
/*==============================================================*/
...
alter table Offre add constraint FK_association16 foreign key (idFavori)
      references Favorie (idFavori) on delete restrict on update restrict;
