...
alter table Candidature add constraint FK_association01 foreign key (idMembre, idCandidat)
...
alter table link add constraint FK_link1 foreign key (idMembre, idRecruteur)
      references Recruteur (idMembre, idRecruteur) on delete restrict on update restrict;
