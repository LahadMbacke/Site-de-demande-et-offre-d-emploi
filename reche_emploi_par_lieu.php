...
$nom =null;
$lieu = $_POST['lieu'];
foreach ($lieu as $color){ 
   $ville =  $color;
   echo $nom;
}


   $req = "SELECT * FROM offre O INNER JOIN emploie E ON O.idOffre = E.idOffre where  O.region=?";
...
<!--    <div id="filtre">
    ...
    <input id="largeur" type="search" name="" placeholder="metier">
   ...
   <?php 
    ...
    <div class="w3-content container card"  >
        <div id="Rech_offre" >
            <div class="w3-row-padding hauteur">
                 <img src="<?php echo $row['logoEntrprise'];?>" class="picture-left" width="120"/>
                 <div class="paragraph-right">
                        <a> <h2 class="w3-text-blue"> <?php echo $row["nom"]; ?>(H/F) </h2> </a>    <small><?php echo $row["typeContrat"]; ?> * <strong> <?php echo $row["region"]; ?> </strong></small> <br>          
                        <div id="desc">
...
$("a").click(function(e) {
  e.preventDefault(); 
  var id = this.href.split('=').pop(); // recupere le id 
  $.ajax({
    type: "get",
    url: "detail.php",
